...
class OccasionProductsPage extends StatefulWidget {
  ...
  @override
  _OccasionProductsPageState createState() => _OccasionProductsPageState();
}

class _OccasionProductsPageState extends State<OccasionProductsPage> {
  ...
  Future<void> fetchProductsByOccasion() async {
    setState(() {
      isLoading = true;
      errorMessage = '';
    });
    ...
    try {
      final response = await http.get(
        Uri.parse(
          'http://192.168.88.100:5000/api/products?occasion=${widget.occasion}',
        ),
    ...
    return Scaffold(
      ...
      body:
          isLoading
              ...
              : products.isEmpty
              ? Center(child: Text('No products found for ${widget.occasion}'))
              : Padding(
